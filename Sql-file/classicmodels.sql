...
(2, 'Kim', 'kim@example.com', '0000-00-00');
...
--
-- Table structure for table `salaries_fr_after_delete`
--

CREATE TABLE `salaries_fr_after_delete` (
  `employeeNumber` int(11) NOT NULL,
  `validFrom` date NOT NULL,
  `salary` decimal(12,2) NOT NULL DEFAULT 0.00
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Dumping data for table `salaries_fr_after_delete`
--

INSERT INTO `salaries_fr_after_delete` (`employeeNumber`, `validFrom`, `salary`) VALUES
(1056, '2000-01-01', '60000.00'),
(1076, '2000-01-01', '70000.00');

--
-- Triggers `salaries_fr_after_delete`
--
DELIMITER $$
CREATE TRIGGER `afer_salaries_delete` AFTER DELETE ON `salaries_fr_after_delete` FOR EACH ROW UPDATE salarybudgets SET total = total - old.salary
$$
DELIMITER ;
...
INSERT INTO `salaryarchives` (`id`, `employeeNumber`, `validFrom`, `salary`, `deletedAt`) VALUES
(1, 1002, '2000-01-01', '50000.00', '2024-08-30 09:52:12');
...
(1, '2003 Harlry-Davidson Eagle Drag Bike', 385, 2024, 1),
(2, '1969 Corvair Monza', 132, 2024, 1),
(3, '1970 Playmouth Hemi Cuda', 132, 2024, 1);
...
IF OLD.quantity <> new.quantity THEN INSERT INTO saleschange(salesId,beforeQuantity, afterQuantity)
...
CREATE TRIGGER `before_sales_update` BEFORE UPDATE ON `sales` FOR EACH ROW BEGIN
 ...
 SET errorMessage = CONCAT('This new quantity', New.quantity, 'cannot be 3 times greater than the current quantity', OLD.quantity);
...
--
-- Table structure for table `saleschange`
--
...
CREATE TABLE `saleschange` (
  ...
  `changeedAt` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `saleschange`
--

INSERT INTO `saleschange` (`id`, `salesId`, `beforeQuantity`, `afterQuantity`, `changeedAt`) VALUES
(1, 1, 150, 350, '2024-08-30 06:36:54'),
(2, 1, 350, 385, '2024-08-30 06:41:25'),
(3, 2, 150, 165, '2024-08-30 06:41:25'),
(4, 3, 200, 220, '2024-08-30 06:41:25'),
(5, 1, 385, 150, '2024-08-30 06:45:16'),
(6, 2, 165, 120, '2024-08-30 06:45:30'),
(7, 3, 220, 120, '2024-08-30 06:45:43'),
(8, 1, 150, 350, '2024-08-30 06:46:08'),
(9, 1, 350, 385, '2024-08-30 06:46:57'),
(10, 2, 120, 132, '2024-08-30 06:46:57'),
(11, 3, 120, 132, '2024-08-30 06:46:57');
...
--
-- Indexes for table `salaries_fr_after_delete`
--
ALTER TABLE `salaries_fr_after_delete`
  ADD PRIMARY KEY (`employeeNumber`);
...
ALTER TABLE `sales`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `product` (`product`,`fiscalYear`,`fiscalMonth`);

--
-- Indexes for table `saleschange`
--
ALTER TABLE `saleschange`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `saleschange`
--
ALTER TABLE `saleschange`
